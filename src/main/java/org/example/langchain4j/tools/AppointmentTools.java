//Function Calling实现ai调用service层操作MySql数据库
...
public class AppointmentTools {
    ...
    @Tool(name="预约挂号", value = "根据参数，先执行执行工具方法queryDepartment查询是否有可预约医生，并直接给用户回答是否可预约，并让用户确认所有预约信息，用户确认后再进行预约。如果用户没有提供具体的医生姓名，请从向量存储中找到一位医生。")
