...
public class RAGTest {
    ...
    public void testReadDocument() {
        ...
        Document document = FileSystemDocumentLoader.loadDocument("C:\\Users\\29390\\OneDrive\\Desktop\\data\\LangChain4j\\knowledge\\测试.txt");
    ...
    public void testReadDocumentAndStore() {
        ...
        Document document = FileSystemDocumentLoader.loadDocument("C:\\Users\\29390\\OneDrive\\Desktop\\data\\LangChain4j\\knowledge\\人工智能.md");
    ...
    public void testTokenCount() {
        ...
        //计算 token 长度
        //QwenTokenizer tokenizer = new QwenTokenizer(System.getenv("DASH_SCOPE_API_KEY"),"qwen-plus");
        int count;
        try (HuggingFaceTokenizer tokenizer = new HuggingFaceTokenizer()) {
            count = tokenizer.estimateTokenCountInMessage(userMessage);
        }
